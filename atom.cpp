...
//------------------------------------------------------
  ...
  molecule_flag = q_flag = wf_flag = mu_flag = 0;
...
Atom::~Atom()
{
  ...
  memory->destroy(q);
  memory->destroy(workfunction);
  memory->destroy(previous_icontacts);
  memory->destroy(mu);
...
void *Atom::extract(const char *name,int &len) 
{
  ...
  if (strcmp(name,"workfunction") == 0) return (void *) workfunction;
  ...
  if (strcmp(name, "previous_icontacts") == 0) return (void *) previous_icontacts;
  //if (strcmp(name,"workfunction") == 0) return (void *) workfunction;
