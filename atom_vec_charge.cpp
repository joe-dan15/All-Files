...
void AtomVecCharge::grow(int n)
{
  ...
  workfunction = memory->grow(atom->workfunction,nmax,"atom:workpotential"); //was it this?
  previous_icontacts = memory->grow(atom->previous_icontacts, nmax, 3, "atom:previous_icontacts");
...
void AtomVecCharge::grow_reset()
{
  ...
  q = atom->q;
  workfunction = atom->workfunction;
  previous_icontacts = atom->previous_icontacts;
}
